...
function draw() {
 ...
 // Use fohr loop to display arrow using showArrow() function
...
var posX =playerArcher1.body.position.x;
var posY =playerArcher1.body.position.y;
var angle =playerArcher1.body.angle+PI/2;
